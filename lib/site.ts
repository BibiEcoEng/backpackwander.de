...
export const navigation = [
  ...
  { label: 'Our Deployment Model', href: '/deployment-model' },
...
export const standards = [
  ...
  'Project-Specific QA/QC Procedures'
];

export const deploymentSection = {
  enterprise: {
    headline: 'For Enterprise Clients',
    description:
  ...
  experts: {
    headline: 'For Independent Experts',
    description:
...
export const supportGatewayOptions = [
  {
...
export const footerInfo = {
  ...
  whatsapp: {
    display: '+49 172 8137111',
    url: 'https://wa.me/491728137111'
  },
  socialLinks: [
    { platform: 'LinkedIn', url: 'https://www.linkedin.com/company/backpackwander/' }
  ]
};
